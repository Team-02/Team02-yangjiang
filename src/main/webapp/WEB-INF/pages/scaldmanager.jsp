    ...
    <div id="panel1" class="mini-panel" title="查询条件" iconCls="icon-add" style="width:100%;height:100%; background: linear-gradient(#E0F1FA, #D5EDFA, #C5E7FA, #D5EDFA,#E0F1FA );"
        ...
        <table>
            <tr>
                ...
                <td class="t">通行卡号</td>
                <td><input type="text" id="cartName"></td>
            </tr>
            <tr>
                <td class="t">单位</td>
                <td><input type="text" id="manName"></td>
                <td class="t">员工号</td>
                <td><input type="text" id="staffName"></td>
            </tr>
            <tr>
                <td class="t">关键字</td>
                <td><input type="text" id="point"></td>
            </tr>
        </table>
    </div>
    <div>
        ...
        <div id="datagrid1" class="mini-datagrid" style="width: 100%;">
            <div property="columns">
                ...
                <div field="id" width="120">姓名</div>
                <div field="departmentname" width="120">通行卡号</div>
                <div field="department" width="120">单位</div>
                <div field="address" width="120">员工号</div>
                <div field="address" width="120">RT级别</div>
                <div field="address" width="120">RT编号</div>
                <div field="address" width="120">开始日期</div>
                <div field="address" width="120">结束日期</div>
            </div>
        </div>
    </div>
</div>
