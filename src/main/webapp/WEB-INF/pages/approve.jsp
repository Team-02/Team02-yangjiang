...
<table border="0" cellpadding="1" cellspacing="2">
    ...
    >
        <table>
            ...
            <tr>
                <td class="d">申报单位<span style="color:red">※</span></td>
                <td>
    ...
    >
        <table>
            <tr>
                ...
                <td class="d">部门经费<span style="color:red">※</span></td>
                <td ><input type="text"></td>
            </tr>
            <tr>
                <td class="d">公司自筹<span style="color:red">※</span></td>
                <td colspan="3"><input type="text"></td>
            </tr>
        </table>
    </div>
    <div id="panel4" class="mini-panel" title="审批意见" iconCls="icon-add" style="width:100%;height:auto;background: linear-gradient(#E0F1FA, #D5EDFA, #C5E7FA, #D5EDFA,#E0F1FA );"
         showToolbar="true" showCollapseButton="true" showFooter="true" allowResize="false"
         collapseOnTitleClick="true">
        <table border="0" cellpadding="1" cellspacing="2">
            <tr>
    ...
    <table>
        <tr>
            <td class="d" style="background-color: white;">
                <input type="button" value="不通过" style="width: 50px">
                <input type="button" value="通过" style="width: 50px">
            </td>
        </tr>
    </table>
</table>
