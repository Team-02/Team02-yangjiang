...
<div id="form1">
            ...
            <tr>
                ...
                <td>
                    <input value="" allowInput="false" id="btnEdit1" class="mini-buttonedit user_add"
                           onbuttonclick="onButtonEdit1"  name="hehe" textName="b" style="width: 400px"/>
                </td>
            </tr>
        </table>
    </div>
    <div>
        ...
        <div id="datagrid1" class="mini-datagrid" style="width: 100%;"url="/selectbimsStore" >
            <div property="columns">
                <div type="checkcolumn"></div>
                <div field="bimsStoreName" width="120">卫星库</div>
                <div field="manageStaffName" width="120">管理人员</div>
                <div field="createDate" width="120" dataformatas="yyyy-MM-dd">创建日期</div>
                <div field="effeteFlag" width="120">是否有效</div>
            </div>
        </div>
    </div>
</div>
...
//        mini.formatDate ( Date, "yyyy-MM-dd HH:mm:ss" );
    ...
    function search() {
        ...
        var btnEdit1 = mini.get("btnEdit1").getValue();
        grid.load({bimsStoreName: key,manageStaffName:btnEdit1});
    }
    function getForm() {
        ...
        mini.open({
            ...
            ondestroy: function (action) {
                ...
                if (action == "ok") {
                    ...
                    if (data) {
                        btnEdit.setValue(data.bimsStoreId);
