...
<div id="form1">
    ...
    <table id="table1">
        <tr>
            <td colspan="4">当前位置:综合管理 >> 厂房管理</td>
        </tr>
    </table>
    <div id="panel1" class="mini-panel" title="查询条件" iconCls="icon-add" style="width:100%;height:100%; background: linear-gradient(#E0F1FA, #D5EDFA, #C5E7FA, #D5EDFA,#E0F1FA );"
        ...
        <table>
            ...
            <tr>
                <td class="t">厂房地址</td>
                <td><input type="text" id="plantName"></td>
                <td class="t">机组</td>
                <td>
    ...
    <div>
        ...
        <div id="datagrid1" class="mini-datagrid" style="width: 100%;">
            <div property="columns">
                ...
                <div field="id" width="120">机组</div>
                <div field="departmentname" width="120">厂房名称</div>
                <div field="department" width="120">厂房经理</div>
                <div field="address" width="120">厂房地址</div>
                <div field="address" width="120">创建日期</div>
            </div>
        </div>
    </div>
</div>
